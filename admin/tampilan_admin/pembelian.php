                ...
                <table class="table table-hover" style="border: 5px solid #253D93;" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td >
                          <a class="nav-" href="detail.php?halaman=detail&id=<?php echo $pecah['id_pembelian']; ?>" >
                            <span class="btn btn-info" style=" width: 130px; background-color: #28B5B5;" >Detail</span>
                          </a>
                          <!-- kalau br di hapus tombolnya nya jdi sejajar kesamping -->
                           <br></br>

                          <?php if ($pecah['status_pembelian']!=="pending"): ?>
                            <a href="pembayaran.php?halaman=pembayaran&id=<?php echo $pecah['id_pembelian']; ?>" >
                              <span class="btn btn-info" style=" width: 130px; background-color:#6ECB63;">Pembayaran</span></a>
                          <?php endif ?>
                      </td>
                    </tr>
                    <?php $nomor++; ?>
